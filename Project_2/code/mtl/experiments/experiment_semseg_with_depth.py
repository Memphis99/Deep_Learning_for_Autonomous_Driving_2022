...
class ExperimentSemsegDepth(pl.LightningModule):
    def __init__(self, cfg):
        ...
        self.depth_mean = self.datasets[SPLIT_TRAIN].depth_meters_mean
        self.depth_stddev = self.datasets[SPLIT_TRAIN].depth_meters_stddev
        self.depth_meters_mean = np.log(self.depth_mean ** 2/((self.depth_mean ** 2 + self.depth_stddev ** 2) ** 0.5))
        self.depth_meters_stddev = (np.log(1 + (self.depth_stddev ** 2)/(self.depth_mean ** 2))) ** 0.5
    ...
    def inference_step(self, batch):
        ...
        y_hat_depth_meters = (
                torch.exp(y_hat_depth * self.depth_meters_stddev + self.depth_meters_mean)
