...
def command_line_parser(args=None):
    ...
    parser.add_argument(
        '--model_name', type=str, default='deeplabv3p', choices=['deeplabv3p', 'branched_architecture', 'task_distillation', 'add_skipconnections', 'distillation_V2'], help='CNN architecture')
    parser.add_argument(
